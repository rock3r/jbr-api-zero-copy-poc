...
public interface JBRSkia {
    ...
    /** Supports compact save plus fill-rect plus save records. */
    ...
    /**
     * Command-list operation: save the canvas state, fill a rectangle, then save the canvas state again.
     */
    int COMMAND_SAVE_FILL_RECT_SAVE = Integer.parseInt("92");
    /**
    ...
    int COMMAND_SAVE_TRANSLATE_LAYER_SAVE_TRANSLATE_DRAW_IMAGE_REF_FULL_RESTORE_N_SAVE_TRANSLATE_LAYER_SAVE_TRANSLATE =
            Integer.parseInt("97");
    /**
     * Command-list operation: fill a rectangle, save an alpha layer, clip the layer, save the canvas state, save
    ...
    interface ScopedSkiaCanvas extends AutoCloseable {
         ...
         *     radius]}</li>
         *     <li>{@link JBRSkia#COMMAND_SAVE_FILL_RECT_SAVE}: {@code [op, 36, flags, argb, x, y, width, height,
         *     radius]}</li>
         ...
         *     nextNestedDy1000]}</li>
         *     <li>{@link JBRSkia#COMMAND_FILL_RECT_SAVE_LAYER_CLIP_RECT_SAVE_SAVE_LAYER_SAVE_TRANSLATE}:
